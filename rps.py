...
def game(quant_r, quant_p, quant_s):
	items = []
	for _ in range(33):
		items.append(Item((random.randint(20, RESX-20), random.randint(20, RESY-20)), quant_r, (0, 0), 'r'))
		items.append(Item((random.randint(20, RESX-20), random.randint(20, RESY-20)), quant_p, (0, 0), 'p'))
		items.append(Item((random.randint(20, RESX-20), random.randint(20, RESY-20)), quant_s, (0, 0), 's'))
		#print(*items)
	while True:
