...
def game(quant_r, quant_p, quant_s):
    ...
    while True:
        ...
        # print("quants",quant_s, quant_r, quant_p)
        verify_is_ended = verify_end(items, quant_r+quant_s+quant_p)
...
for i in range(1000):
    game(random.randint(15, 60), random.randint(15, 60), random.randint(15, 60))
    print(str(i)+" of 1000 \n")

simulations_csv_data = df.to_csv("rand_simul.csv", index=False)
pygame.quit()
